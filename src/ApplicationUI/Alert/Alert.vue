<template>
  <div :class="['rounded-md p-4', {'bg-gray-50': is('default'), 'bg-green-50': is('success'), 'bg-red-50': is('danger'), 'bg-yellow-50': is('warning'), 'bg-blue-50': is('info')}]">
    <div class="flex">
      <div :class="['flex-shrink-0']">
        ...
        <InformationCircleIcon v-else :class="['h-5 w-5', {'text-gray-400': is('default'), 'text-blue-400': is('info')}]" aria-hidden="true"/>
      </div>
      <div class="ml-3">
        <slot>
